...
public class GamePanel extends JPanel {
    ...
    private void onCardClicked(String cardId, String cardType) {
        ...
        String[] options;
        String message = "What would you like to do with this card?";


        if ("PROPERTY".equals(cardType)) {
            options = new String[]{
                    "PLAY_PROPERTY", "PLAY_MONEY"
            };
        } else if ("ACTION".equals(cardType) || "RENT".equals(cardType)) {
            options = new String[]{"PLAY_ACTION", "PLAY_MONEY"
            };
        } else {
            options = new String[]{"PLAY_MONEY"};
        }
